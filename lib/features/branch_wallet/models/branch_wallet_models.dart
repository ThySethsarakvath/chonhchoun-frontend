class BranchWalletInfo {
  ...
  factory BranchWalletInfo.fromJson(Map<String, dynamic> json) {
    double numberValue(dynamic value) {
      if (value is num) return value.toDouble();
      return double.tryParse(value?.toString() ?? '') ?? 0;
    }

    return BranchWalletInfo(
...
class BranchWalletBranchInfo {
  final String id;
  final String name;
  final int? branchNumber;
  final String? code;

  const BranchWalletBranchInfo({
    required this.id,
    required this.name,
    this.branchNumber,
    this.code,
  ...
  factory BranchWalletBranchInfo.fromJson(Map<String, dynamic> json) {
    return BranchWalletBranchInfo(
      id: json['_id'] as String? ?? '',
...
class BranchWalletView {
  final BranchWalletBranchInfo branch;
  final BranchWalletInfo wallet;
  ...
  factory BranchWalletView.fromJson(Map<String, dynamic> json) {
    return BranchWalletView(
      branch: BranchWalletBranchInfo.fromJson(
        (json['branch'] as Map<String, dynamic>?) ?? <String, dynamic>{},
      ),
      wallet: BranchWalletInfo.fromJson(
...
class BranchWalletSummary {
  ...
  factory BranchWalletSummary.fromJson(Map<String, dynamic> json) {
    double numberValue(dynamic value) {
      if (value is num) return value.toDouble();
      return double.tryParse(value?.toString() ?? '') ?? 0;
    }

    return BranchWalletSummary(
...
class BranchWalletTransaction {
  ...
  factory BranchWalletTransaction.fromJson(Map<String, dynamic> json) {
    double numberValue(dynamic value) {
      if (value is num) return value.toDouble();
      return double.tryParse(value?.toString() ?? '') ?? 0;
    }
